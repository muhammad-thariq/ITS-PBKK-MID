        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                {{-- <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="py-1 bg-white shadow-lg rounded-md z-50">
                            <x-dropdown-link :href="route('profile.edit')" class="text-gray-800 hover:bg-gray-100 hover:text-gray-900">
                                {{ __('Profile') }}
                            </x-dropdown-link>

                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <x-dropdown-link :href="route('logout')" class="text-gray-800 hover:bg-gray-100 hover:text-gray-900"
